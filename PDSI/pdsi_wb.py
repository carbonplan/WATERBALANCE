    ...
    **kwargs
    ...
    if logical_not(isempty(test2)):
        ...
        if logical_not(isempty(test3)):
            ...
            # pdsi_wb.m:45
            test4 = find(
                (P(test2(test3)) - PET(test2(test3)) - RS(test2(test3)))
                < (PRU(test2(test3)))
            )
            # pdsi_wb.m:46
            ...
            if logical_not(isempty(test4)):
                ...
                RU[test2(test3(test4))] = (
                    P(test2(test3(test4)))
                    - PET(test2(test3(test4)))
                    - RS(test2(test3(test4)))
                )
                # pdsi_wb.m:50
            ...
            if logical_not(isempty(test5)):
                RU[test2(test3(test5))] = WCBOT(test2(test3(test5))) - SU(
                    test2(test3(test5))
                )
                # pdsi_wb.m:55
                RO[test2(test3(test5))] = (
                    P(test2(test3(test5)))
                    - PET(test2(test3(test5)))
                    - RS(test2(test3(test5)))
                    - RU(test2(test3(test5)))
                )
            # pdsi_wb.m:56
